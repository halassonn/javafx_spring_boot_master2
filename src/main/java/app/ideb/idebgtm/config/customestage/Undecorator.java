...
public class Undecorator extends StackPane {
    ...
    public Undecorator(Stage stage, Region root) {
        this(stage, root, "/stage/stagedecoration.fxml", StageStyle.UNDECORATED);
    }
...
//          super.getChildren().addAll(clientArea,stageDecoration, glassPane);
    ...
    public void setFadeInTransition() {
        ...
        stage.showingProperty().addListener(new ChangeListener<Boolean>() {
            ...
            public void changed(ObservableValue<? extends Boolean> ov, Boolean t, Boolean t1) {
                if (t1.booleanValue()) {
                    FadeTransition fadeTransition = new FadeTransition(Duration.seconds(0.5), Undecorator.this);
    ...
    public void setFadeOutTransition() {
        FadeTransition fadeTransition = new FadeTransition(Duration.seconds(0.3), Undecorator.this);
...
//                node.setLayoutY(SHADOW_WIDTH + RESIZE_PADDING);
    ...
    public void setDockFeedbackVisible(double x, double y, double width, double height) {
        ...
        dockFadeTransition.setDuration(Duration.millis(100));
    ...
    void loadConfig() {
        ...
        try {
            // System.out.println(Undecorator.class.getClassLoader().getResourceAsStream("skin/undecorator.properties"));
